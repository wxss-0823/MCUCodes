...
#
# Script generated by Vivado on Thu Apr 18 18:03:23 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : floating_point_7.sh
...
#
# Usage        : floating_point_7.sh
#                floating_point_7.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_7.sh [-reset_run]
#                floating_point_7.sh [-reset_log]
#                floating_point_7.sh [-help]
#
...
#                script (type 'floating_point_7.sh -help' for more information).
#
...
# script info
echo -e "floating_point_7.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_7.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_7 xil_defaultlib.glbl -o floating_point_7_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_7_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_7_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_7_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_7.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating_point_7.sh [-help]\n\
Usage: floating_point_7.sh [-step]\n\
Usage: floating_point_7.sh [-lib_map_path]\n\
Usage: floating_point_7.sh [-reset_run]\n\
Usage: floating_point_7.sh [-reset_log]\n\
Usage: floating_point_7.sh [-keep_index]\n\
Usage: floating_point_7.sh [-noclean_files]\n\n\
