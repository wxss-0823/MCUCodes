...
#
# Script generated by Vivado on Thu Apr 18 18:04:01 +0800 2024
...
#
# Usage        : floating_point_8.sh
#                floating_point_8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_8.sh [-reset_run]
#                floating_point_8.sh [-reset_log]
#                floating_point_8.sh [-help]
#
...
#                script (type 'floating_point_8.sh -help' for more information).
#
...
# script info
echo -e "floating_point_8.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_8 xil_defaultlib.glbl -o floating_point_8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_8_simv.daidir vcs_lib c.obj)
...
Usage: floating_point_8.sh [-step]\n\
Usage: floating_point_8.sh [-lib_map_path]\n\
Usage: floating_point_8.sh [-reset_run]\n\
Usage: floating_point_8.sh [-reset_log]\n\
Usage: floating_point_8.sh [-keep_index]\n\
